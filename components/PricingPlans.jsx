...
import { PLANS_CONTENT } from "@/app/constrains"
            ...
            className="grid grid-cols-1 md:grid-cols-3  gap-8">
                {PLANS_CONTENT.plans.map((plan, index) => (
                    <motion.div
                        ...
                        className={`bg-neutral-950 p-8 rounded-xl shadow-lg 
                        ${
                        plan.popular ? 'border-2 border-blue-900/80' : 'border border-neutral-800'
                        }`}>
                            ...
                            <h3 className="text-lg lg:text-xl tracking-tighter uppercase mb-4"> 
                                {plan.name}
                            </h3>
