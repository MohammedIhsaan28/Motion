'use client';
import { HOW_IT_WORKS_CONTENT } from "@/app/constrains";
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    <div className="flex -space-x-2">
                                        {step.users.map((user, userIndex) => (
                                            <Image key={userIndex} 
                                            className="inline-block h-8 w-8 rounded-full ring-2 ring-neutral-900 border border-neutral-800" 
                                            src={user} alt={`Person ${userIndex+1}`}/>
                                        ))}
                                    </div>
